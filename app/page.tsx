	...
	return (
		<main>
			<div
				...
				<Link href="/products">
					<div className="flex flex-col items-start justify-start h-30 mt-52 bg-gray-900 hover:bg-gray-500 cursor-pointer transition-colors duration-200 text-gray-100 p-4 rounded-md">
